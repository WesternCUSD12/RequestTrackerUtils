...
October 10, 2025 3. Direct PDF download instead of opening in new window 4. Print preview before automatic printing 5. Integration with network printers for direct printing
